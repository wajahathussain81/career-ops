...
// hub/ is a bespoke web dashboard deployed independently to a homelab LXC/NAS,
// never shipped by update-system.mjs. It follows the same isolation contract.
const EXCLUDE_PREFIXES = ['web/', 'hub/'];
...
if (process.argv.includes('--self-test')) {
  ...
  assert(covered('hub/server.mjs') === true, 'hub/ tree must be covered (isolation-contract prefix exclude)');
  assert(covered('hub-sibling/x.mjs') === false, 'hub-sibling/ must NOT ride the hub/ prefix exclude');
